...
public class AtmosphereEffect : ScriptableRendererFeature
{
    [System.Serializable]
    public class AtmosphereEffectFeatureSettings
    {
    ...
    public AtmosphereEffectFeatureSettings settings = new AtmosphereEffectFeatureSettings();

    RenderTargetHandle renderTextureHandle;
    AtmosphereEffectRenderPass myRenderPass;

    public override void Create()
    {
        myRenderPass = new AtmosphereEffectRenderPass(
          "Atmosphere Effect custom pass",
